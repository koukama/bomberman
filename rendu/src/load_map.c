...
** Last update Tue Jul  3 12:59:26 2018 REBOUL Simon
*/
...
void	add_objects(t_game *game, int index_tile, int _x, int _y, int layer)
{
  add_object(game, index_tile, _x, _y, layer);
}

void	add_object(t_game *game, int index_tile, int _x, int _y, int layer)
{
  t_object	*obj;
  ...
  obj->hitbox->x = _x * MAP_MARGIN_X;
  obj->hitbox->y = _y * MAP_MARGIN_Y;
...
void	add_falling_object(t_game *game, int index_tile, int _x, int _y, int layer, int offset)
{
  t_object	*obj;
